...
export interface paths {
    ...
    "/v1/transactions/net_revenue_summary": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
         ...
         * @description **Scopes**: `transactions:read`
         */
        get: operations["transactions:get_net_revenue_summary"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface operations {
    ...
    "transactions:get_net_revenue_summary": {
        parameters: {
            query: {
                account_id: string;
            };
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["NetRevenueSummary"];
                };
            };
            /** @description Validation Error */
            422: {
